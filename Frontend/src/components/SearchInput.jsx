...
function SearchInput(props) {
  const { query, setQuery, handleSearch, isSearching } = props;
      ...
      <div className="relative group">
        ...
        <div className="relative flex items-center gap-2 bg-neutral-900 border border-neutral-800 rounded-2xl p-2 hover:border-red-600/50 transition-all duration-300 shadow-lg">
          ...
          <button
            ...
            className={
              isSearching
                ? "bg-red-900 backdrop-blur-md opacity-50 text-white font-medium px-8 py-2 rounded-xl shadow-[0_0_40px_rgba(188,34,34,0.15)] transition-all duration-300"
                : "bg-red-600 hover:bg-red-700 text-white font-medium px-8 py-2 rounded-xl shadow-[0_0_40px_rgba(188,34,34,0.15)] transition-all duration-300"
            }
          >
            Search
          </button>
